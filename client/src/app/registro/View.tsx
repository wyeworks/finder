...
export default function Form() {
    return (
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8" id="register-view">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm" id="register-header">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm" id="register-body">
                <RegisterForm />
