          ...
          {user.socialNetworks && (
            <div className='mb-5 flex max-w-[375px] flex-row items-center justify-evenly'>
              {user.socialNetworks.instagram && (
                <InstagramButton link={user.socialNetworks.instagram} />
              )}
              {user.socialNetworks.linkedin && (
                <LinkedInButton link={user.socialNetworks.linkedin} />
              )}
              {user.socialNetworks.twitter && (
                <TwitterButton link={user.socialNetworks.twitter} />
              )}
              {user.socialNetworks.discord && (
                <DiscordButton link={user.socialNetworks.discord} />
              )}
            </div>
          )}
