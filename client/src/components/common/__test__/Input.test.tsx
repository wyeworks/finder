...
describe("Input Component", () => {
    ...
    it("should have default placeholder and validation text when not provided", () => {
        const { getByPlaceholderText, getByText } = render(
            <Input type="text" id="default-input" name="testName" label="Test" touched={true} />
        );
    ...
    it("should display validation text when input is touched and contains an invalid value", () => {
        const { getByText } = render(
            <Input type="text" id="invalid-input" name="testName" label="Test" touched={true} required={true} />
        );
        expect(getByText("Por favor ingrese su Test")).toBeInTheDocument();
    });
    ...
    it("should handle input changes", () => {
        ...
        const { getByLabelText } = render(
            <Input type="text" id="change-input" name="testName" label="Test" onChange={handleChange} />
        );
